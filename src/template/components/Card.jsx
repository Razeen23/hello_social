...
export default function Card() {
    ...
    const handleWhatsApp = () => {
        window.open('https://wa.me/6369288358', '_blank'); // Ensure no "+" or space
    };
...
/>
                        ...
                        <div className="fixed bottom-5 right-5 z-50 bg-green-500 rounded-full p-4 mb-20 shadow-lg hover:bg-green-600">
                            <a
