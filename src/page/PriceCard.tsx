    ...
    return (
      ...
      <div className="pricing-wrapper text-wrap">
        {pricingPlans.map((plan, index) => (
          <div className="font-secondary rounded-2xl p-5 mb-3 bg-slate-800 shadow">
            <div key={index} className=" max-w-[320px]  px-5 py-10 ">
              ...
              <div className="mt-5 text-white text-center">
                <p className="text-lg font-bold">
                  Spend more <span className="text-yellow-500 text-2xl" >₹199</span> to get <br /> a Personalized Designer
                </p>
